...
namespace Illuminate\Http\Client {
    ...
    class Factory {
         ...
         * @static 
         */
        public static function discord($token = null)
        {
            return \Illuminate\Http\Client\Factory::discord($token);
        }
         ...
         * @static 
         */
        public static function discordBot()
        {
            return \Illuminate\Http\Client\Factory::discordBot();
        }
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
         ...
         * @static 
         */
        public static function getOrPaginate($maxResults = 500, $defaultSize = 25)
        {
            return \Illuminate\Database\Eloquent\Builder::getOrPaginate($maxResults, $defaultSize);
        }
